...
function Card(props) {
  return (
    <div className="w-[285px] shrink-0 grow " >
      ...
      <div className="ml-2 text-xl font-bold">{props.title}</div>
      <div className="font-bold"> 
        <Star className="inline ml-2"  />{props.rating}
       <span className="inline ml-1 font-bold"> {props.minTime} - {props.maxTime}min</span>
        </div>
        <div className="ml-2">
            {props.name} <br />
            {props.place}
